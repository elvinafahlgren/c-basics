...
##
## Debug
ProjectName            :=Rita-ut-bild
ConfigurationName      :=Debug
WorkspacePath          :=D:/mop/myWorkspace2.0
ProjectPath            :=D:/mop/myWorkspace2.0/Lektion8
...
ObjectsFileList        :="Rita-ut-bild.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/Rita-ut-bild Debug/Rita-ut-bild.s19
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/Rita-ut-bild > Debug/Rita-ut-bild.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "D:/mop/myWorkspace2.0/Lektion8/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
