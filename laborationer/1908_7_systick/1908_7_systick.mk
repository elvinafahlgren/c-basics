...
##
## Debug
ProjectName            :=1908_7_systick
ConfigurationName      :=Debug
WorkspacePath          :=D:/mop/laborationer
ProjectPath            :=D:/mop/laborationer/1908_7_systick
...
ObjectsFileList        :="1908_7_systick.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/1908_7_systick Debug/1908_7_systick.s19
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/1908_7_systick > Debug/1908_7_systick.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "D:/mop/laborationer/1908_7_systick/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
