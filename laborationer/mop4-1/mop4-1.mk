...
ProjectPath            :=/home/elvina/Dokument/MOP/laborationer/mop4-1
...
PostBuild:
	...
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/mop4-1.elf Debug/mop4-1.s19
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/mop4-1.elf > Debug/mop4-1.dass
	@echo Done
...
## Objects
##
$(IntermediateDirectory)/systick_irq.c$(ObjectSuffix): systick_irq.c
	...
	$(CC) $(SourceSwitch) "/home/elvina/Dokument/MOP/laborationer/mop4-1/systick_irq.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/systick_irq.c$(ObjectSuffix) $(IncludePath)
