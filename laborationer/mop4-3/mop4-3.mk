...
ProjectPath            :=D:/mop/laborationer/mop4-3
...
PostBuild:
	...
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/mop4-3 Debug/mop4-3.s19
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/mop4-3 > Debug/mop4-3.dass
	@echo Done
...
## Objects
##
$(IntermediateDirectory)/flipflop_irq_ack.c$(ObjectSuffix): flipflop_irq_ack.c
	...
	$(CC) $(SourceSwitch) "D:/mop/laborationer/mop4-3/flipflop_irq_ack.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/flipflop_irq_ack.c$(ObjectSuffix) $(IncludePath)
