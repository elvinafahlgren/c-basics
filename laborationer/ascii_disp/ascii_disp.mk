...
##
## Debug
ProjectName            :=ascii_disp
ConfigurationName      :=Debug
WorkspacePath          :=D:/mop/laborationer
ProjectPath            :=D:/mop/laborationer/ascii_disp
...
ObjectsFileList        :="ascii_disp.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/ascii_disp Debug/ascii_disp.s19
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/ascii_disp > Debug/ascii_disp.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c
	...
	$(CC) $(SourceSwitch) "D:/mop/laborationer/ascii_disp/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
