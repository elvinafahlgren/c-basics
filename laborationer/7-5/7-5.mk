...
ProjectPath            :=D:/mop/laborationer/7-5
...
PostBuild:
	...
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/7-5 Debug/7-5.s19
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/7-5 > Debug/7-5.dass
	@echo Done
...
$(IntermediateDirectory)/usart_buffered.c$(ObjectSuffix): usart_buffered.c
	...
	$(CC) $(SourceSwitch) "D:/mop/laborationer/7-5/usart_buffered.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/usart_buffered.c$(ObjectSuffix) $(IncludePath)
