...
ProjectPath            :=/home/elvina/Dokument/MOP/laborationer/testlib
...
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)/home/elvina/Dokument/MOP/laborationer/libMD407/Debug 
...
PostBuild:
	...
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/testlib.elf Debug/testlib.s19
	/usr/share/codelite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/testlib.elf > Debug/testlib.dass
	@echo Done
...
$(IntermediateDirectory)/startup-crt.c$(ObjectSuffix): startup-crt.c
	...
	$(CC) $(SourceSwitch) "/home/elvina/Dokument/MOP/laborationer/testlib/startup-crt.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup-crt.c$(ObjectSuffix) $(IncludePath)
