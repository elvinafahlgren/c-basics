...
##
## Debug
ProjectName            :=testlib2
ConfigurationName      :=Debug
WorkspacePath          :=D:/mop/laborationer
ProjectPath            :=D:/mop/laborationer/testlib2
...
PostBuild:
	...
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objcopy -S -O srec  Debug/testlib2 Debug/testlib2.s19
	D:\Nedladdningar\CodeLite/tools/gcc-arm/bin/arm-none-eabi-objdump -D -S Debug/testlib2 > Debug/testlib2.dass
	@echo Done
...
$(IntermediateDirectory)/startup-crt.c$(ObjectSuffix): startup-crt.c
	...
	$(CC) $(SourceSwitch) "D:/mop/laborationer/testlib2/startup-crt.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup-crt.c$(ObjectSuffix) $(IncludePath)
